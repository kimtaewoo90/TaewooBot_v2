...
namespace TaewooBot_v2
{
    public class StockState
    {
        ...
        public bool MonitoringSignals_Strategy1()
        {
            ...
            if (states_TickOneMinList.Average() > BotParams.BeforeAvg[states_ShortCode] * 3 && BotParams.BeforeAvg[states_ShortCode] != 0)
                signal_2 = true;

            // 거래대금도 detail 하게 다시 잡기
            if (states_TickOneMinList.Sum() * double.Parse(states_CurPrice) > 200000000)
                signal_3 = true;
