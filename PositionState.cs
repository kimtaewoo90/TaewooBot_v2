...
namespace TaewooBot_v2
{
    ...
    public class PositionState
    {
        ...
        public string position_OrderQty { get; set; }
        ...
        public PositionState(string ShortCode, string KrName, string OrderQty, string BalanceQty, string BuyPrice, string CurPrice, string Change, string TradingPnL)
        {
            position_ShortCode = ShortCode;
            position_KrName = KrName;
            position_OrderQty = OrderQty;
